...
network --bootproto=static --ip=192.168.140.102 --netmask=255.255.0.0 --gateway=192.168.0.253 --nameserver=192.168.0.253 --hostname=esxi-host101 --device=vmnic0
...
esxcli network ip interface ipv4 set --interface-name=vmk1 --ipv4=192.168.141.102 --netmask=255.255.0.0 --type=static
esxcli network ip interface ipv4 set --interface-name=vmk2 --ipv4=192.168.142.102 --netmask=255.255.0.0 --type=static
